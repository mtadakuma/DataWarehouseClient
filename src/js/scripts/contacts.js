...
class Contacts{
    async getContacts() {
        try {
            ...
            let result = await fetch('https://proyecto-data-warehouse.herokuapp.com/contacts', {
                headers,
            });
...
class AllRegionsCities {
    async getAllRegionsCities() {
        try {
            ...
            let result = await fetch('https://proyecto-data-warehouse.herokuapp.com/allRegionsCities', {
                headers,
            });
            let data = await result.json();
...
class Channels {
    async getChannels() {
        try {
            ...
            let result = await fetch('https://proyecto-data-warehouse.herokuapp.com/channels', {
                headers,
            });
            let data = await result.json();
...
class Companies {
    async getCompanies() {
        try {
            ...
            let result = await fetch('https://proyecto-data-warehouse.herokuapp.com/companies', {
                headers,
            });
            let data = await result.json();
...
class UI {
    ...
    async submitContact() {
        submitPopUp.addEventListener('click', async () => {
            ...
            if (submitPopUp.textContent.includes('Agregar')) {
                url = 'https://proyecto-data-warehouse.herokuapp.com/contacts';
                fetchMethod = 'POST';
                ...
                url = `https://proyecto-data-warehouse.herokuapp.com/contacts/${idParam}`;
                fetchMethod = 'PUT';
                fetchBody = JSON.stringify({ firstName, lastName, position, email, address, cities_id, companies_id,interest,channels});
    ...
    async deleteContacts() {
        btnDelAllContacts.addEventListener('click', async () => {
            ...
            /*info for fetch*/
            let url = `https://proyecto-data-warehouse.herokuapp.com/contacts`;
